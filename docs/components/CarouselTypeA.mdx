...
import { ExampleCarouselTypeA } from "@site/src/components/CarouselTypeA";
...
```js title="src/components/UserIndicatorComponent/index.tsx" showLineNumbers
...
```js title="src/components/UserNavigationButtons/index.tsx" showLineNumbers
